...
class AlbumSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'ITEM_PIPELINES': {
            'meitu_tmp.pipelines.DownloadAlbumImagesPipeline': 300,
        }
    }
    ...
    def __init__(self):
        ...
        with session_scope() as session:
            ...
            models = session.query(MeituAlbum).filter(MeituAlbum.cover_backup == None, MeituAlbum.cover.like('http%')).limit(10).all()
