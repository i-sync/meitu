...
class OrganizeSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'ITEM_PIPELINES': {
            'meitu_tmp.pipelines.DownloadTagImagesPipeline': 300,
        }
    }
    ...
    def __init__(self):
        ...
        with session_scope() as session:
            ...
            models = session.query(MeituTag).filter(MeituTag.cover_backup == None, MeituTag.cover.like('http%')).limit(10).all()
