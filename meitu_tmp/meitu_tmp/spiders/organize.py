...
class OrganizeSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'ITEM_PIPELINES': {
            'meitu_tmp.pipelines.DownloadOrganizeImagesPipeline': 300,
        }
    }
    ...
    def __init__(self):
        ...
        with session_scope() as session:
            ...
            models = session.query(MeituOrganize).filter(MeituOrganize.cover_backup == None, MeituOrganize.cover.like('http%')).limit(2).all()
