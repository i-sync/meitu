...
async def street(request: Request, page = "1", order = "new"):
    ...
    with session_scope() as session:
        ...
        sql = text(f"select * from meitu_media where meitu_media.category_name = 'street' and meitu_media.is_enabled = 1 order by meitu_media.{order_by} desc limit {page.limit} offset {page.offset}")
